...
def reg():
    ...
    if to in r:
        ...
        print(' WhatsApp : +03212854372')

        input('\033[1;97m Press Enter To Send Token')

        os.system('xdg-open https://wa.me/+923212854372?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
...
def reg2():
    ...
    print(' WhatsApp : +923212854372')

    input(' Press Enter To Send Token ')

    os.system('xdg-open https://wa.me/+923212854372?text=Assalamualaikum Sir Approve my Token and my Token :'+id)
